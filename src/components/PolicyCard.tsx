...
export function PolicyCard({ policy }: PolicyCardProps) {
  ...
  return (
    ...
    >
      ...
      >
        <span className="text-xs text-muted-foreground w-[5.5rem] shrink-0" style={{ fontFamily: "'Inter', 'Helvetica Neue', sans-serif" }}>
          {formattedDate}
        </span>
        <span className="text-sm text-secondary-foreground w-[7rem] shrink-0 truncate" style={{ fontFamily: "'Inter', 'Helvetica Neue', sans-serif" }}>
          {policy.company}
        </span>
        ...
        <span className="text-xs w-[7rem] shrink-0 text-right tabular-nums" style={{ fontFamily: "'Inter', 'Helvetica Neue', sans-serif" }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-3">
            {hasFinancials && (
              <div className="space-y-1">
                <h4 className="text-xs font-medium text-primary mb-2" style={{ fontFamily: "'Georgia', 'Times New Roman', serif" }}>
                  Datos Financieros
                </h4>
